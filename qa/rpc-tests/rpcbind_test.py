...
def run_bind_test(tmpdir, allow_zmg, connect_to, addresses, expected):
    '''
    ...
    if allow_zmg:
        base_args += ['-rpcallowip=' + x for x in allow_zmg]
...
def run_allowip_test(tmpdir, allow_zmg, rpchost, rpcport):
    '''
    Start a node with rpcwallow IP, and request getinfo
    at a non-localhost IP.
    '''
    base_args = ['-disablewallet', '-nolisten'] + ['-rpcallowip='+x for x in allow_zmg]
