Contributing to Zmining
============================

The Zmining project operates an open contributor model where anyone is
...
The following applies to code changes to the Zmining project, and is not to be
confused with overall Zmining Network Protocol consensus changes.

Whether a pull request is merged into Zmining rests with the project merge
...
The project leader is the release manager for each Zmining release.
