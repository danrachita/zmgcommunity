...
RESOURCES += src/qt/zmg.qrc src/qt/zmg_locale.qrc

TRANSLATIONS += src/qt/locale/zmg_bg.ts \
                src/qt/locale/zmg_de.ts \
                src/qt/locale/zmg_en.ts \
                src/qt/locale/zmg_es.ts \
                src/qt/locale/zmg_fi.ts \
                src/qt/locale/zmg_fr.ts \
                src/qt/locale/zmg_it.ts \
                src/qt/locale/zmg_ja.ts \
                src/qt/locale/zmg_pl.ts \
                src/qt/locale/zmg_pt.ts \
                src/qt/locale/zmg_ru.ts \
                src/qt/locale/zmg_sk.ts \
                src/qt/locale/zmg_sv.ts \
                src/qt/locale/zmg_vi.ts \
                src/qt/locale/zmg_zh_CN.ts \
                src/qt/locale/zmg_zh_TW.ts
