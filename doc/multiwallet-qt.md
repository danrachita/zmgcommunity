...
In order to support loading of multiple wallets in zmg-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zmg.cpp.
...
Changes to zmg.cpp
----------------------
zmg.cpp is the entry point into zmg-qt, and as such, will require some minor modifications to provide hooks for
